      ...
      <main className="container mx-auto p-4 flex flex-col justify-center items-center text-center min-h-screen">
        <div className="mb-8 mt-16 w-full px-4"> {/* Added padding for better fit on mobile */}
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-8">
            <a href="/docs/Asha_Mweene_resume.pdf" download className="bg-blue-500 text-navy px-6 py-2 rounded-md transition duration-300 ease-in-out transform hover:scale-105 hover:bg-blue-700">Download Resume</a>
            <a href="/docs/Asha_Mweene_resume.pdf" target="_blank" rel="noopener noreferrer" className="bg-green text-navy px-6 py-2 rounded-md transition duration-300 ease-in-out transform hover:scale-105 hover:bg-green-700">View Resume</a>
          </div>
          <iframe src="/docs/Asha_Mweene_resume.pdf" className="w-full h-96 mb-8 shadow-lg rounded-md" title="Resume" />
        </div>
