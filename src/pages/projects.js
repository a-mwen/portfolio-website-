...
const categories = {
  ...
  "Databases": [
    { 
      ...
      description: "Develop a system to catalog and manage library resources.", 
...
`,
    ...
    { title: "Inventory Management - COMING SOON", description: "Create a database to manage inventory levels and orders.", image: "/path/to/inventory.jpg", github: "#", tech: "MySQL, Express, Node.js" }
  ],
  "Machine Learning": [
    { title: "Image Classification", description: "Build a model to classify images into categories.", image: "https://media.geeksforgeeks.org/wp-content/uploads/20230215093923/CNN-Architectures-1.png", github: "https://github.com/a-mwen/-image-classification", tech: "Python, TensorFlow, Keras", snippet: `# Load dataset\nimport numpy as np\nfrom tensorflow.keras.datasets import cifar10\nfrom tensorflow.keras.utils import to_categorical\n\n(X_train, y_train), (X_test, y_test) = cifar10.load_data()\n\n# Normalize data\nX_train = X_train.astype('float32') / 255.0\nX_test = X_test.astype('float32') / 255.0\n\n# One-hot encode labels\ny_train = to_categorical(y_train, 10)\ny_test = to_categorical(y_test, 10)\n\n# Build model\nmodel = Sequential([\n  Conv2D(32, (3, 3), activation='relu', input_shape=(32, 32, 3)),\n  MaxPooling2D((2, 2)),\n  Conv2D(64, (3, 3), activation='relu'),\n  MaxPooling2D((2, 2)),\n  Conv2D(128, (3, 3), activation='relu'),\n  MaxPooling2D((2, 2)),\n  Flatten(),\n  Dense(128, activation='relu'),\n  Dropout(0.5),\n  Dense(10, activation='softmax')\n])\nmodel.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])` },
    { title: "Recommendation System - COMING SOON", description: "Create a system to recommend products or content to users.", image: "/path/to/recommendation.jpg", github: "#", tech: "Python, Scikit-Learn" }
  ],
  "Mobile Development": [
    { title: "Fitness Tracker App System - COMING SOON", description: "Create an app to track workouts and fitness goals.", image: "/path/to/fitness.jpg", github: "#", tech: "Swift, Firebase" },
    { title: "Task Management App System - COMING SOON", description: "Develop a mobile app to manage tasks and to-do lists.", image: "/path/to/task.jpg", github: "#", tech: "React Native, Redux" }
  ],
  "Other": [
    { title: "Custom Electronics - COMING SOON", description: "Work on projects involving microcontrollers and sensors.", image: "/path/to/electronics.jpg", github: "#", tech: "C++, Arduino" },
